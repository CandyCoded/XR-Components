...
namespace CandyCoded.XRComponents
{
    ...
    public static class InputManagerSetup
    {
        ...
        public static void SetupAxes()
        {
            ...
            AddAxis(new Axis
            {
                m_Name = InputMapping.Oculus_CrossPlatform_PrimaryIndexTrigger.ToString(),
                dead = 0.19f,
                sensitivity = 1,
                type = 2,
                axis = 8
            ...
            AddAxis(new Axis
            {
                m_Name = InputMapping.Oculus_CrossPlatform_SecondaryIndexTrigger.ToString(),
                dead = 0.19f,
                sensitivity = 1,
                type = 2,
                axis = 9
            ...
            AddAxis(new Axis
            {
                m_Name = InputMapping.Oculus_CrossPlatform_PrimaryHandTrigger.ToString(),
                dead = 0.19f,
                sensitivity = 1,
                type = 2,
                axis = 10
            ...
            AddAxis(new Axis
            {
                m_Name = InputMapping.Oculus_CrossPlatform_SecondaryHandTrigger.ToString(),
                dead = 0.19f,
                sensitivity = 1,
                type = 2,
                axis = 11
            ...
            AddAxis(new Axis
            {
                m_Name = InputMapping.Oculus_CrossPlatform_Button_1.ToString(),
            ...
            AddAxis(new Axis
            {
                m_Name = InputMapping.Oculus_CrossPlatform_Button_2.ToString(),
            ...
            AddAxis(new Axis
            {
                m_Name = InputMapping.Oculus_CrossPlatform_Button_3.ToString(),
            ...
            AddAxis(new Axis
            {
                m_Name = InputMapping.Oculus_CrossPlatform_Button_4.ToString(),
            ...
            AddAxis(new Axis
            {
                m_Name = InputMapping.Oculus_CrossPlatform_Button_Start.ToString(),
            ...
            AddAxis(new Axis
            {
                m_Name = InputMapping.Oculus_CrossPlatform_PrimaryThumbstickHorizontal.ToString(),
                dead = 0.19f,
                sensitivity = 1,
                invert = false,
                type = 2,
            ...
            AddAxis(new Axis
            {
                m_Name = InputMapping.Oculus_CrossPlatform_PrimaryThumbstickVertical.ToString(),
                dead = 0.19f,
                sensitivity = 1,
                invert = true,
                type = 2,
            ...
            AddAxis(new Axis
            {
                m_Name = InputMapping.Oculus_CrossPlatform_SecondaryThumbstickHorizontal.ToString(),
                dead = 0.19f,
                sensitivity = 1,
                invert = false,
                type = 2,
            ...
            AddAxis(new Axis
            {
                m_Name = InputMapping.Oculus_CrossPlatform_SecondaryThumbstickVertical.ToString(),
                dead = 0.19f,
                sensitivity = 1,
                invert = true,
                type = 2,
        ...
        public static bool AxisDefined(string m_Name)
        {
            ...
            for (var i = 0; i < axesProperty.arraySize; i += 1)
            {
